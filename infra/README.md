...
3. Generate some number for terraform state and locks
4. Create `secrets.yml` from `secrets.yml.example`
5. Put generated number to `terraform_state_random_suffix`
...
9. Init terraform (assuming in `infra/{component}`)
